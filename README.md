...
Меня зовут Дмитрий, я Junior QA Engineer!
...
Изучаю алгоритмы и фреймворки (Selenium, Cypress).
...
- Стать полноценным QA-инженером: обеспечивать стабильность релизов, системно подходить к тестированию и развивать автоматизацию;
- Стремлюсь применять тест-дизайн и приоритизацию дефектов для максимального влияния на качество продукта;
- Работать в дружной команде профессионалов;
- Участвовать в интересных и значимых проектах;
- Вносить существенный вклад в успех компании.
...
[![Telegram Badge](https://img.shields.io/badge/-Telegram-0088cc?style=flat-square&logo=Telegram&logoColor=white)](https://t.me/blitzi97)
